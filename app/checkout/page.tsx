...
const paymentMethods = [
  ...
  },
  {
    ...
    icon: <QrCode size={20} />,
    methods: [
      { id: 'qris', name: 'QRIS (Semua Aplikasi)', fee: 0 },
    ]
  },
  {
    category: "Minimarket",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                      ...
                      {category.methods.map((method) => (
                        ...
                        >
                          ...
                          <span className="text-white/50 text-sm">
                            {method.fee > 0 ? `+${formatPrice(method.fee)}` : 'Gratis'}
                          </span>
                        </button>
                      ))}
                    </div>
            ...
            <div className="lg:col-span-2">
              <div className="glass p-6 rounded-3xl border border-white/10 sticky top-28">
                <h2 className="text-lg font-bold text-white mb-6">Detail Pesanan</h2>
                ...
                <div className="border-t border-white/10 pt-4 space-y-3 mb-6">
                  <div className="flex justify-between text-sm">
                    <span className="text-white/50">Harga Item</span>
                    <span className="text-white">{formatPrice(orderSummary.price)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-white/50">Biaya Admin</span>
                    <span className="text-white">{adminFee > 0 ? formatPrice(adminFee) : 'Gratis'}</span>
                  </div>
